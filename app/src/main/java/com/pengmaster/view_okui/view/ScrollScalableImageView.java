...
public class ScrollScalableImageView extends View implements NestedScrollingChild2 {
    private static final float IMAGE_WIDTH = Utils.px2dp(300);
    ...
    public ScrollScalableImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
