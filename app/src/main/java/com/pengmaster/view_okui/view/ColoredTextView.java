...
public class ColoredTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private static final int CORNER_RADIUS = (int) Utils.px2dp(4);
    private static final int X_PADDING = (int) Utils.px2dp(16);
    private static final int Y_PADDING = (int) Utils.px2dp(8);
